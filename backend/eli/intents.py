...
WAKE_PREFIX = re.compile(r"^(?:hey |hi |ok |okay )?(?:eli|ellie|elly|ely)[,!.]?\s+", re.I)
...
PATTERNS: list[tuple[str, re.Pattern]] = [
    ...
    ("youtube", re.compile(
        r"^(?:search|look up|find|play)(?: on)? youtube for (.+?)[.!?]?$"
        r"|^(?:search|look up|find|play) (.+?) on youtube[.!?]?$", re.I)),
    ("search", re.compile(
        r"^(?:search|google|look up)(?: the web| google| online| the internet)?(?: for)? (.+?)[.!?]?$", re.I)),
    ("type_in", re.compile(r"^(?:write|type) (.+?) (?:in|into) (notepad|vs code|vscode|word|the editor)[.!]?$", re.I)),
    ...
    ("stop_talking", re.compile(r"^(?:stop|be quiet|shut up|silence|stop talking)[.!]?$", re.I)),
